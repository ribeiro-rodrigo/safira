const BeanBuilder = require('./builder/BeanBuilder');
...
class Safira{
    ...
    define(beanClass,beanName){
        const builder = new BeanBuilder(beanClass,beanName,true,this);
    ...
    _createObject(definitions){
        ...
        if(definitions.postConstruct)
            Reflect.apply(definitions.object[definitions.postConstruct],definitions.object,[]);
        else
            if(definitions.object.created)
                Reflect.apply(definitions.object.created,definitions.object,[]);
    }
}

exports.newContainer = () => new Safira();
exports.Safira = Safira;